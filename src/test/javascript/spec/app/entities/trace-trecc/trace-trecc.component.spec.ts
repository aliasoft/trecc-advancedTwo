...
import { TraceTreccComponent } from 'app/entities/trace-trecc/trace-trecc.component';
...
describe('Component Tests', () => {
  describe('TraceTrecc Management Component', () => {
    let comp: TraceTreccComponent;
    let fixture: ComponentFixture<TraceTreccComponent>;
    let service: TraceTreccService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [TreccTestModule],
        declarations: [TraceTreccComponent],
        providers: [
          {
        ...
        .overrideTemplate(TraceTreccComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(TraceTreccComponent);
