...
import fr.sncf.cpr.trecc.config.audit.AuditEventConverter;
import fr.sncf.cpr.trecc.domain.PersistentAuditEvent;
...
import static fr.sncf.cpr.trecc.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
